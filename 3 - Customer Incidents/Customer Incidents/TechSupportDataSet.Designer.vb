...
Partial Public Class TechSupportDataSet
    ...
    Partial Public Class IncidentsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddIncidentsRow(ByVal parentCustomersRowByFK_Incidents_Customers As CustomersRow, ByVal ProductCode As String, ByVal DateOpened As Date, ByVal DateClosed As Date, ByVal Title As String) As IncidentsRow
            Dim rowIncidentsRow As IncidentsRow = CType(Me.NewRow,IncidentsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nothing, ProductCode, DateOpened, DateClosed, Title}
...
Namespace TechSupportDataSetTableAdapters
    ...
    Partial Public Class CustomersTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Customer_Incidents.My.MySettings.Default.TechSupportConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        CustomerID, Name, Address, City, State, ZipCode, Phone, Email"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM"& _ 
                "            Customers"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (CustomerID = @CustomerID)"
        ...
        Public Overloads Overridable Function FillByCustomerID(ByVal dataTable As TechSupportDataSet.CustomersDataTable, ByVal CustomerID As Integer) As Integer
    ...
    Partial Public Class IncidentsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Incidents] WHERE (([IncidentID] = @Original_IncidentID) AND (["& _ 
                ...
                "AND ([DateOpened] = @Original_DateOpened) AND ((@IsNull_DateClosed = 1 AND [Date"& _ 
                "Closed] IS NULL) OR ([DateClosed] = @Original_DateClosed)) AND ([Title] = @Origi"& _ 
                "nal_Title))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_DateClosed", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "DateClosed", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Incidents] SET [CustomerID] = @CustomerID, [ProductCode] = @Product"& _ 
                "Code, [DateOpened] = @DateOpened, [DateClosed] = @DateClosed, [Title] = @Title W"& _ 
                "HERE (([IncidentID] = @Original_IncidentID) AND ([CustomerID] = @Original_Custom"& _ 
                "erID) AND ([ProductCode] = @Original_ProductCode) AND ([DateOpened] = @Original_"& _ 
                "DateOpened) AND ((@IsNull_DateClosed = 1 AND [DateClosed] IS NULL) OR ([DateClos"& _ 
                "ed] = @Original_DateClosed)) AND ([Title] = @Original_Title));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT IncidentI"& _ 
                "D, CustomerID, ProductCode, DateOpened, DateClosed, Title FROM Incidents WHERE ("& _ 
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_DateClosed", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "DateClosed", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT IncidentID, CustomerID, ProductCode, DateOpened, DateClosed, Title FROM db"& _ 
                "o.Incidents"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT IncidentID, CustomerID, ProductCode, DateOpened, DateClosed, Title FROM db"& _ 
                "o.Incidents"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (CustomerID = @CustomerID)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CustomerID", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "CustomerID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByCustomerID(ByVal dataTable As TechSupportDataSet.IncidentsDataTable, ByVal CustomerID As Integer) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(CustomerID,Integer)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Overridable Function Delete(ByVal Original_IncidentID As Integer, ByVal Original_CustomerID As Integer, ByVal Original_ProductCode As String, ByVal Original_DateOpened As Date, ByVal Original_DateClosed As Global.System.Nullable(Of Date), ByVal Original_Title As String) As Integer
            ...
            If (Original_DateClosed.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(Original_DateClosed.Value,Date)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CustomerID As Integer, ByVal ProductCode As String, ByVal DateOpened As Date, ByVal DateClosed As Global.System.Nullable(Of Date), ByVal Title As String, ByVal Original_IncidentID As Integer, ByVal Original_CustomerID As Integer, ByVal Original_ProductCode As String, ByVal Original_DateOpened As Date, ByVal Original_DateClosed As Global.System.Nullable(Of Date), ByVal Original_Title As String, ByVal IncidentID As Integer) As Integer
            ...
            If (DateClosed.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(DateClosed.Value,Date)
            Else
            ...
            If (Original_DateClosed.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_DateClosed.Value,Date)
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(12).Value = CType(IncidentID,Integer)
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
            If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
                Me.Adapter.UpdateCommand.Connection.Open
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CustomerID As Integer, ByVal ProductCode As String, ByVal DateOpened As Date, ByVal DateClosed As Global.System.Nullable(Of Date), ByVal Title As String, ByVal Original_IncidentID As Integer, ByVal Original_CustomerID As Integer, ByVal Original_ProductCode As String, ByVal Original_DateOpened As Date, ByVal Original_DateClosed As Global.System.Nullable(Of Date), ByVal Original_Title As String) As Integer
            Return Me.Update(CustomerID, ProductCode, DateOpened, DateClosed, Title, Original_IncidentID, Original_CustomerID, Original_ProductCode, Original_DateOpened, Original_DateClosed, Original_Title, Original_IncidentID)
        End Function
    End Class
